...
body::before {
  ...
  background-position: center 80%;   /* descend encore plus bas (65% → 80%) */
  background-size: 130vmin;          /* un peu plus grand pour compenser */
  opacity: 0.05;                     /* visible mais pas trop fort */
  pointer-events: none;
  z-index: 0;
}
